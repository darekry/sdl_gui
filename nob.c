...
static const char *common_flags[] = {
    ...
    "-Wreorder", "-Wzero-as-null-pointer-constant", "-Wunreachable-code",
    "-Wstrict-aliasing", "-Wpedantic", "-Wcast-align", "-Wcast-qual",
    "-Wctor-dtor-privacy", "-Wdisabled-optimization", "-Winit-self",
    "-Wmissing-declarations", "-Winline", "-Wdouble-promotion",
    "-Wnull-dereference", "-Wextra-semi", "-Wsign-promo",
    "-stdlib=libc++", "-std=c++23", "-I/usr/include/SDL2", "-Isrc", "-Ilib",
};

static const char *debug_flags[] = {
    "-g", "-O0", "-fsanitize=address,undefined",
    "-fno-omit-frame-pointer", "-fno-optimize-sibling-calls", "-DDEBUG=1",
};
...
static const char *hpp_order[] = {
    "src/easing.hpp", "src/sdl_deleters.hpp", "src/layout_parser.hpp",
    "src/sgml_parser.hpp", "src/json_parser.hpp", "src/timer_manager.hpp",
    "src/animation_manager.hpp", "src/style.hpp", "src/font_manager.hpp",
    "src/texture_manager.hpp", "src/theme.hpp", "src/gui.hpp",
    "src/label.hpp", "src/panel.hpp", "src/button.hpp", "src/checkbox.hpp",
    "src/slider.hpp", "src/text_input.hpp", "src/canvas.hpp", "src/cursor.hpp",
    "src/animated_image.hpp", "src/radio_button.hpp", "src/radio_group.hpp",
    "src/tab_control.hpp", "src/text_area.hpp", "src/combobox.hpp",
    "src/context_menu.hpp", "src/gui_manager.hpp", "src/sdl_app.hpp",
    "src/composite/dialog_box.hpp", "src/composite/message_box.hpp",
};

static const char *includes_to_remove[] = {
    "#include \"easing.hpp\"", "#include \"sdl_deleters.hpp\"",
    "#include \"layout_parser.hpp\"", "#include \"sgml_parser.hpp\"",
    "#include \"json_parser.hpp\"", "#include \"timer_manager.hpp\"",
    "#include \"animation_manager.hpp\"", "#include \"style.hpp\"",
    "#include \"font_manager.hpp\"", "#include \"texture_manager.hpp\"",
    "#include \"theme.hpp\"", "#include \"gui.hpp\"", "#include \"label.hpp\"",
    "#include \"panel.hpp\"", "#include \"button.hpp\"", "#include \"checkbox.hpp\"",
    "#include \"slider.hpp\"", "#include \"text_input.hpp\"", "#include \"canvas.hpp\"",
    "#include \"cursor.hpp\"", "#include \"animated_image.hpp\"",
    "#include \"radio_button.hpp\"", "#include \"radio_group.hpp\"",
    "#include \"tab_control.hpp\"", "#include \"text_area.hpp\"",
    "#include \"combobox.hpp\"", "#include \"context_menu.hpp\"",
    "#include \"gui_manager.hpp\"", "#include \"sdl_app.hpp\"",
    "#include \"composite/dialog_box.hpp\"", "#include \"composite/message_box.hpp\"",
    "#include \"../gui.hpp\"", "#include \"../panel.hpp\"", "#include \"../button.hpp\"",
    "#include \"../label.hpp\"", "#include \"../gui_manager.hpp\"",
    "#include \"../theme.hpp\"", "#include \"../text_input.hpp\"",
    "#include \"dialog_box.hpp\"", "#include \"../lib/tinyxml2.h\"",
};
