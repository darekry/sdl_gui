...
[Ta strona jest dostępna po angielsku](../en/feature_proposals.md)
...
- System Animacji — architektura i API: [docs/pl/proposals/animation_system_proposal.md](proposals/animation_system_proposal.md)
- Architektura Systemu Stylizacji — motywy i style: [docs/pl/proposals/styling_system_architecture.md](proposals/styling_system_architecture.md)
