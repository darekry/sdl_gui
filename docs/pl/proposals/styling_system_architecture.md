...
[Ta strona jest dostępna po angielsku](../../en/proposals/styling_system_architecture.md)
...
Biorąc pod uwagę Ziele biblioteki (elastyczność i rozszerzalność), obecny, dynamiczny model wydaje się lepszym wyborem.
