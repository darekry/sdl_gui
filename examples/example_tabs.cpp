...
int main(int, char**) {
    try {
        ...
        tab1Panel->setStyle(ElementState::Normal, {.borderColor={{255, 0, 0, 128}}, .borderWidth=5});
        tab2Panel->setStyle(ElementState::Normal, {.borderColor={{0, 255, 0, 128}}, .borderWidth=5});
        tab3Panel->setStyle(ElementState::Normal, {.borderColor={{0, 0, 255, 128}}, .borderWidth=5});
