...
int main(int, char**) {
    try {
        ...
        hProgress->setTooltip("Horizontal progress bar showing value 3");
        ...
        vProgress->setTooltip("Vertical progress bar showing value 2");
        guiManager.addElement(std::move(vProgress));

        // Animated loading progress bar with start button
        ...
        startBtn->setTooltip("Start the loading animation");
        ...
        startBtn->setOnClickCallback([aProgressRef, animManager](GUIElement*) {
